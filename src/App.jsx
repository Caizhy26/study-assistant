        ...
        <div style={S.root}>
            <style>{`
                * { box-sizing: border-box; }
                html, body, #root { margin: 0; background: #f7f9fd; color: #1a1c1c; }
                ...
                @media (max-width: 1180px) {
                    .now-secondary-grid,
                    .timer-workspace-grid {
                        grid-template-columns: 1fr !important;
                    }
                }
                @media (max-width: 960px) {
                    [data-app-main="true"] > div { max-width: 100%; }
                }
            `}</style>
            ...
            <header style={S.header}>
                <div style={S.headerInner}>
                    <div style={{ display: "flex", alignItems: "center", gap: 22, flexWrap: "wrap" }}>
                        <div>
                            <div style={S.kicker}>SUN YAT-SEN UNIVERSITY</div>
            ...
            <nav style={S.nav}>
                <div style={S.sidebarTop}>
                    <div>
                        ...
                        <div style={S.sidebarCaption}>Now · Plan · Focus</div>
                    </div>
                </div>
                    ...
                    {TABS.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                style={{
                                    ...S.navBtn,
                                    color: isActive ? "#ffffff" : "rgba(236,240,252,0.58)",
                                    fontWeight: isActive ? 700 : 600,
                                    background: isActive ? "linear-gradient(135deg, rgba(255,255,255,0.18), rgba(255,255,255,0.1))" : "transparent",
                                    boxShadow: isActive ? "inset 0 0 0 1px rgba(255,255,255,0.08), 0 12px 20px rgba(0,0,0,0.12)" : "none",
                                }}
                            >
                ...
                <div style={S.sidebarFooter}>
                    <div style={S.footerPill}>一步一件事，把难题拆小</div>
                </div>
            </nav>
        </div>
    );
